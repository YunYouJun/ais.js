  ...
  <div style="margin: 10px;">
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      <el-form-item :label="label1">
        <el-switch v-model="formInline.switch" active-color="#13ce66" inactive-color="#ff4949">
        </el-switch>
      </el-form-item>
      <el-form-item :label="label2">
        <el-input v-model="formInline.portName" placeholder="端口名" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item :label="label3">
        <el-input v-model="formInline.baudRate" placeholder="波特率" :disabled="true"></el-input>
      </el-form-item>
    </el-form>
